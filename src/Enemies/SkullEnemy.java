...
public class SkullEnemy extends Enemy {
	 private float gravity = .5f;
	    ...
	    public SkullEnemy(Point location, Direction facingDirection) {
	        super(location.x, location.y, new SpriteSheet(ImageLoader.load("SkullEnemy.png"), 32, 32), "WALK_LEFT");
